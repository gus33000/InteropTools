...
namespace InteropTools.Controls.SplitViews
{
	public sealed class SwipeableSplitView : SplitView
	{
		...
		{
			get {
				return (bool)GetValue(IsSwipeablePaneOpenProperty);
			}
		...
		{
			get {
				return (double)GetValue(PanAreaInitialTranslateXProperty);
			}

			set {
				SetValue(PanAreaInitialTranslateXProperty, value);
			}
		}
		...
		{
			get {
				return (double)GetValue(PanAreaThresholdProperty);
			}

			set {
				SetValue(PanAreaThresholdProperty, value);
			}
		}
		...
		{
			get {
				return (bool)GetValue(IsPanSelectorEnabledProperty);
			}

			set {
				SetValue(IsPanSelectorEnabledProperty, value);
			}
		}
