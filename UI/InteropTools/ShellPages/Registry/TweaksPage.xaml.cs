        ...
        private void Refresh()
        {
            ...
            AddInputTweak(() =>
            {
                GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Shell\\Dictation",
                                    "DictationSilenceAutoStopTimeout", RegTypes.REG_DWORD, out RegTypes regtype, out string regvalue);
                return regvalue;
            },
            state =>
            {
            ...
            {
                GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Shell\\Dictation",
                                    "FormFillingDictationSilenceAutoStopTimeout", RegTypes.REG_DWORD, out RegTypes regtype, out string regvalue);
                return regvalue;
            },
            state =>
            {
            ...
            {
                GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Shell\\Start",
                                    "TileFlyoutSubtileFocusChangeTimerInterval", RegTypes.REG_DWORD, out RegTypes regtype, out string regvalue);
                return regvalue;
            },
            state =>
            {
