...
namespace InteropTools.ShellPages.Registry
{
	...
	public sealed partial class TweaksPage
	{
        ...
        {
            var res = AsyncHelpers.RunSync<GetKeyValueReturn>(() => _helper.GetKeyValue(hive, key, valuename, type));
            valtype = res.regtype;
            value = res.regvalue;
        ...
        private void Refresh()
		{
			AddBoolTweak(() =>
			{
				string BrightSliderValue;
				RegTypes BrightSliderType;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Shell\\Docking",
				                    "EnabledForTest", RegTypes.REG_DWORD, out BrightSliderType,
				                    out BrightSliderValue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\OEM\\NOKIA\\Display\\ColorAndLight",
				                    "UserSettingNoBrightnessSettings", RegTypes.REG_DWORD, out BrightSliderType,
				                    out BrightSliderValue);
			...
			async state =>
			{
				...
				else
				{
					...
					var result = AsyncHelpers.RunSync<HelperErrorCodes>(() => _helper.DeleteValue(RegHives.HKEY_LOCAL_MACHINE,
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE,
				                    ...
				                    RegTypes.REG_BINARY, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, @"SYSTEM\CurrentControlSet\Services\KeepWiFiOnSvc",
				                    "Start", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			state =>
			{
				...
				{
					_helper.SetKeyValue(RegHives.HKEY_LOCAL_MACHINE,
					                    @"SOFTWARE\Microsoft\EventSounds\Sounds\WiFiConnected", "Disabled", RegTypes.REG_DWORD, "0");
					_helper.SetKeyValue(RegHives.HKEY_LOCAL_MACHINE,
					                    @"SOFTWARE\Microsoft\EventSounds\Sounds\WiFiDisconnected", "Disabled", RegTypes.REG_DWORD,
					                    "0");
				}
				...
				{
					_helper.SetKeyValue(RegHives.HKEY_LOCAL_MACHINE,
					                    @"SOFTWARE\Microsoft\EventSounds\Sounds\WiFiConnected", "Disabled", RegTypes.REG_DWORD, "1");
					_helper.SetKeyValue(RegHives.HKEY_LOCAL_MACHINE,
					                    @"SOFTWARE\Microsoft\EventSounds\Sounds\WiFiDisconnected", "Disabled", RegTypes.REG_DWORD,
					                    "1");
				}
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, @"SYSTEM\ControlSet001\Services\NlpmService",
				                    "ImagePath", RegTypes.REG_EXPAND_SZ, out regtype, out regvalue);
			...
			}, state =>
			{
				...
				_helper.SetKeyValue(RegHives.HKEY_LOCAL_MACHINE,
				                    ...
				                    "4.1.12.4");
				_helper.SetKeyValue(RegHives.HKEY_LOCAL_MACHINE,
				                    @"SOFTWARE\OEM\Nokia\NokiaSvcHost\Plugins\NsgGlance\NlpmService", "PluginVersion", RegTypes.REG_SZ,
				                    "4.1.12.4");
				_helper.SetKeyValue(RegHives.HKEY_LOCAL_MACHINE,
				                    @"SOFTWARE\OEM\Nokia\NokiaSvcHost\Plugins\NsgGlance\NlpmService", "Enabled", RegTypes.REG_DWORD, "1");
				_helper.SetKeyValue(RegHives.HKEY_LOCAL_MACHINE,
				                    @"SOFTWARE\OEM\Nokia\NokiaSvcHost\Plugins\NsgGlance\NlpmService", "UsingBeta", RegTypes.REG_DWORD,
				                    "0");
				_helper.SetKeyValue(RegHives.HKEY_LOCAL_MACHINE,
				                    @"SOFTWARE\OEM\Nokia\NokiaSvcHost\Plugins\NsgGlance\NlpmService", "UseBeta", RegTypes.REG_DWORD, "0");
				...
				_helper.SetKeyValue(RegHives.HKEY_LOCAL_MACHINE, @"SOFTWARE\OEM\Nokia\lpm", "DoubleTapEnabled",
				                    RegTypes.REG_DWORD, "0");
				_helper.SetKeyValue(RegHives.HKEY_LOCAL_MACHINE, @"SOFTWARE\OEM\Nokia\lpm", "Enabled", RegTypes.REG_DWORD,
				                    "1");
				_helper.SetKeyValue(RegHives.HKEY_LOCAL_MACHINE, @"SOFTWARE\OEM\Nokia\lpm", "MinimizeIcon",
				                    RegTypes.REG_DWORD, "0");
				_helper.SetKeyValue(RegHives.HKEY_LOCAL_MACHINE, @"SOFTWARE\OEM\Nokia\lpm", "Mode", RegTypes.REG_DWORD,
				                    "0");
				...
				_helper.SetKeyValue(RegHives.HKEY_LOCAL_MACHINE, @"SOFTWARE\OEM\Nokia\lpm", "ShowDetailedAppStatus",
				                    RegTypes.REG_DWORD, "0");
				_helper.SetKeyValue(RegHives.HKEY_LOCAL_MACHINE, @"SOFTWARE\OEM\Nokia\lpm", "ShowSystemNotifications",
				                    RegTypes.REG_DWORD, "0");
				_helper.SetKeyValue(RegHives.HKEY_LOCAL_MACHINE, @"SOFTWARE\OEM\Nokia\lpm", "FontFile", RegTypes.REG_SZ,
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, @"Software\Microsoft\FingerKB\Options",
				                    "ForceLargeScreenDevice", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Windows Phone\\LanguageCPL",
				                    "CPLMode", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Internet Explorer\\Debug",
				                    "Debug Endpoint", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\TaskHost",
				                    "EnableWebBrowserBorder", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\TaskHost",
				                    "EnableWebBrowserLogger", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\TaskHost",
				                    "EnableDefaultDocModeForLegacyApp", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Internet Explorer\\Debug",
				                    "DisableEntityExtraction", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Internet Explorer\\Debug",
				                    "TouchEvents", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Internet Explorer\\Main",
				                    "DisableEdgeEngine", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Email\\OemSettings\\DarkTheme",
				                    "Disabled", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Contacts\\Sim",
				                    "EnableSIMAddressBookAndExport", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Contacts\\Settings",
				                    "FeaturesEnabled", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\ActiveSync",
				                    "DisablePIIStripping", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Silverlight",
				                    "EnableMediaLogDisplay", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\PhoneShareHost",
				                    "EnableDataPackageHost", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Silverlight",
				                    "DisableYUVComposition", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Silverlight",
				                    "DisableDCompForVideo", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Silverlight",
				                    "EnableFramerateCounter", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Zune\\TestHooks",
				                    "InstallAppsToSDTestHook", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Zune\\MusicVideoHub",
				                    "MusicAppRedirectorEnabled", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Data Sense",
				                    "DisableSystemBucket", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Shell\\OEM\\SystemTray",
				                    "DataActivity", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE,
				                    ...
				                    "EnableLevel", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Office Mobile\\OneNote Mobile",
				                    "SyncFileBackupEnabled", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "System\\Search\\ClientConfiguration",
				                    "UseCustomServer", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "System\\Maps\\Configuration",
				                    "ShowRenderStatistics", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Speech\\Dev\\SapiSvr",
				                    "EnableVoiceAgents", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Speech\\Dev\\SapiSvr",
				                    "EnableAllVoiceAgents", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Speech\\Test",
				                    "EnableSpeechRecoServiceAudioSegmentation", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Shell\\Start",
				                    "PinOnInstallComplete", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Shell\\ActionCenter",
				                    "XamlExperienceEnabled", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Shell\\LockAppSettings",
				                    "LockLayer", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Shell\\LockAppSettings",
				                    "LivingImage", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "System\\CurrentControlSet\\Control\\Power",
				                    "TtmEnabled", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Zune\\Playback",
				                    "DisableHardwareMFTUse", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\XAML",
				                    "ReleaseGraphicsDeviceOnSuspend", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\TaskHost",
				                    "AllowUIAutomationForLegacyApps", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\PackageManager",
				                    "EverythingIsLightUp", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\PackageManager",
				                    "ForcedLightupWhiteListEnabled", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "System\\Maps\\Configuration\\DataLoader",
				                    "UseOdvsIntData", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\OEM\\Nokia\\Touch\\WakeupGesture",
				                    "Enabled", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\StigRegKey\\FingerKB",
				                    "ForceWideLayout", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\FingerKB\\Options",
				                    "ShowCommaOnChat", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\StigRegKey\\FingerKB",
				                    "DockedKeyboardEnable", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\FingerKB\\Options",
				                    "CaretDisabled", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\FingerKB\\Options",
				                    "CaretRightHand", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\StigRegKey\\FingerKB",
				                    "MultiSizeLogicEnabled", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddBoolTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\StigRegKey\\FingerKB",
				                    "DragAnchorKeyEnabled", RegTypes.REG_DWORD, out regtype, out regvalue);
			...
			AddInputTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Wallet\\Settings",
				                    "MinimumPinLength", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Wallet\\Services\\WLID",
				                    "FakeLiveId", RegTypes.REG_SZ, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Wallet\\Services\\WLID",
				                    "FakeUserName", RegTypes.REG_SZ, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Shell\\Input",
				                    "DoubleTapTimeThreshold", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Shell\\Input",
				                    "TapAndLongHoldTimeThreshold", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Shell\\Input",
				                    "TapAndHoldStartTimeThreshold", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Shell\\Input",
				                    "TapAndShortHoldTimeThreshold", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Shell\\Input",
				                    "TapAndHoldDurationThreshold", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Shell\\Dictation",
				                    "DictationSilenceAutoStopTimeout", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Shell\\Dictation",
				                    "FormFillingDictationSilenceAutoStopTimeout", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Messaging\\GlobalSettings",
				                    "PduDumpPath", RegTypes.REG_SZ, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Phone\\Settings",
				                    "VoLTEAudioQualityString", RegTypes.REG_SZ, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "System\\Assistant\\ClientConfiguration\\Custom",
				                    "ProactivePageUrl", RegTypes.REG_SZ, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "System\\Assistant\\ClientConfiguration\\Custom",
				                    "ReactiveServerPrefix", RegTypes.REG_SZ, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "System\\Assistant\\ClientConfiguration\\Custom",
				                    "CookieDomain", RegTypes.REG_SZ, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "System\\Assistant\\ClientConfiguration",
				                    "CustomProactiveQueryParams", RegTypes.REG_SZ, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "System\\Assistant\\ClientConfiguration",
				                    "CustomReactiveQueryParams_Cat2", RegTypes.REG_SZ, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "System\\Assistant\\ClientConfiguration",
				                    "CustomReactiveQueryParams_Cat3", RegTypes.REG_SZ, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			state =>
			{
				_helper.SetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Shell\\Start", "DropAreaDelta",
				                    RegTypes.REG_DWORD, state);
			},
			"PFI Drop Area Delta",
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Shell\\Start",
				                    "RippleTimerInterval", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Shell\\Start",
				                    "MarqueeTimerInterval", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Shell\\Start",
				                    "PopTimerInterval", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Shell\\Start",
				                    "GrowTimerInterval", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Shell\\Start",
				                    "TileFlyoutIdleTimerInterval", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Shell\\Start",
				                    "TileFlyoutEndTimerInterval", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Shell\\Start",
				                    "TileFlyoutSubtileFocusChangeTimerInterval", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Shell\\Start",
				                    "CancelTileFlyoutTimerInterval", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Shell\\Start",
				                    "MagnetMaxAltitudeThreshold", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Shell\\Start",
				                    "MagnetMinAltitudeThreshold", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Shell\\Start",
				                    "MagnetTiltThreshold", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Shell\\Start",
				                    "MagnetPopoutThreshold", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Shell\\Start",
				                    "MagnetFadeThreshold", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Shell\\Start",
				                    "MagnetTiltPercent", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Shell\\Start",
				                    "MagnetPopoutDistance", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Shell\\Start",
				                    "MagnetFadePercent", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\Shell\\Lock",
				                    "PolicyIdleTimeout", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\FingerKB\\Options",
				                    "CaretCenterX_Percentage", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\FingerKB\\Options",
				                    "CaretCenterY_Percentage", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\FingerKB\\Options",
				                    "CaretInputWidth_Percentage", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\FingerKB\\Options",
				                    "CaretInputHeight_Percentage", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\FingerKB\\Options",
				                    "MinDistSqCaret", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\FingerKB\\Options",
				                    "MinTimeCaret", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
			...
			AddInputTweak(() =>
			{
				...
				string regvalue;
				GetKeyValue(RegHives.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\FingerKB\\Options",
				                    "DisableTimeCaret", RegTypes.REG_DWORD, out regtype, out regvalue);
				return regvalue;
			},
			state =>
			{
		...
		{
			var control = new TweakBoolControl(Check, Apply, Title, Description);
		...
		{
			var control = new TweakInputControl(Check, Apply, Title, Description);
			BoolTweaks.Children.Add(control);
		}
	}
}