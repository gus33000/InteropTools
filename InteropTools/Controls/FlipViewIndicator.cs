...
namespace InteropTools.Controls
{
    public sealed class FlipViewIndicator : ListBox
    {
        ...
        public static readonly DependencyProperty FlipViewProperty =
            DependencyProperty.Register("FlipView", typeof(FlipView), typeof(FlipViewIndicator), new PropertyMetadata(
                null, (depobj, args) =>
                {
                    ...
                    Binding eb = new()
                    {
                        Mode = BindingMode.TwoWay, Source = fv, Path = new PropertyPath("SelectedItem")
                    };
        ...
        /// </summary>
        public FlipViewIndicator() => DefaultStyleKey = typeof(FlipViewIndicator);
