        ...
        private void Refresh()
        {
            RunInThreadPool(async () =>
            {
                ...
                RunInUIThread(() =>
                {
                    ...
                    else if (buildbranch.IndexOf("rs1", StringComparison.OrdinalIgnoreCase) >= 0)
                    {
                        BackgroundHeroImage.ImageSource = new BitmapImage(new Uri("ms-appx:///Assets/rs1.jpg"));
                    }
                    else if (buildbranch.IndexOf("rs", StringComparison.OrdinalIgnoreCase) >= 0)
                    {
                        BackgroundHeroImage.ImageSource = new BitmapImage(new Uri("ms-appx:///Assets/rs2.jpg"));
                    }
                    else if (buildbranch.IndexOf("feature2", StringComparison.OrdinalIgnoreCase) >= 0)
                    {
                        BackgroundHeroImage.ImageSource = new BitmapImage(new Uri("ms-appx:///Assets/f2.jpg"));
                    }
                    else if (buildbranch.IndexOf("19h1", StringComparison.OrdinalIgnoreCase) >= 0)
                    {
                        BackgroundHeroImage.ImageSource = new BitmapImage(new Uri("ms-appx:///Assets/ti.jpg"));
                    }
                    else if (buildbranch.IndexOf("vb", StringComparison.OrdinalIgnoreCase) >= 0)
                    {
                        BackgroundHeroImage.ImageSource = new BitmapImage(new Uri("ms-appx:///Assets/vb.jpg"));
                    }
                    else if (buildbranch.IndexOf("mn", StringComparison.OrdinalIgnoreCase) >= 0)
                    {
                        BackgroundHeroImage.ImageSource = new BitmapImage(new Uri("ms-appx:///Assets/vb.jpg"));
                    }
                    else if (buildbranch.IndexOf("fe", StringComparison.OrdinalIgnoreCase) >= 0)
                    {
                        BackgroundHeroImage.ImageSource = new BitmapImage(new Uri("ms-appx:///Assets/vb.jpg"));
                    }
                    else if (buildbranch.IndexOf("co", StringComparison.OrdinalIgnoreCase) >= 0)
                    {
                        BackgroundHeroImage.ImageSource = new BitmapImage(new Uri("ms-appx:///Assets/sv.jpg"));
                    }
                });
            });
        }
